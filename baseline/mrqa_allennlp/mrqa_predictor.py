...
class MRQAPredictor(Predictor):
    def predict_json(self, json_dict: JsonDict) -> JsonDict:
        ...
        # formated_predictions = {pred['qid']: [pred['best_span_str'], pred["start_bias_weight"], pred["end_bias_weight"]] for pred in predictions}
        # add raw logits to the prediction file
        formated_predictions = {pred['qid']: [pred['best_span_str'], pred["start_bias_weight"], pred["end_bias_weight"], pred["span_start_logits"], pred["span_end_logits"]] for pred in predictions}
